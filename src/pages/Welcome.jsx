import welcomeImage from "../assets/about2.jpg";
            ...
            <div className="flex flex-col  justify-center gap-y-12 w-full h-full md:w-[500px] px-2">
                ...
                <div className="flex flex-col px-4 gap-y-3 mt-14">
                    <button
                        ...
                        className="w-full py-2 bg-white/50 rounded-full backdrop-blur-lg text-lg font-semibold text-gray-600 cursor-pointer"
                    >
                        Sign in
                    </button>
                    <button
                        onClick={() => navigate("/auth/signup")}
                        className="text-sm font-bold font-raleway text-gray-100 cursor-pointer "
                    >
                        Create an account
                    </button>
                </div>
